...
source plan-env/bin/activate  # On Windows use `plan-env\Scripts\activate`
...
```
conda create --name plan-env python=3.9.7
conda activate plan-env
pip install git+https://github.com/KindXiaoming/pykan.git  # For GitHub installation
# or
pip install plan  # For PyPI installation
```
...
For users who are interested in scientific discoveries and scientific computing (the original users intended for), I'm happy to hear your applications and collaborate. This repo will continue to remain mostly for this purpose, probably without significant updates for efficiency. In fact, there are already implementations like [efficientkan](https://github.com/Blealtan/efficient-kan) or [fouierkan](https://github.com/GistNoesis/FourierKAN/) that look promising for improving efficiency.
